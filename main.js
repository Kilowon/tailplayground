...
<div
				class="display: flex items-center justify-center  w-96 text-sm font-medium text-gray-900  bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
			>
				<li
			  ...
			  <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
				...
				<button class="btn btn-sm btn-ghost text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
function createListItems(text) {
	...
	containerDiv.classList.add(
		'w-80 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white'
	)
